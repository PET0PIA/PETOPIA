...
import {
  downloadReviewStatsExcel,
  getFairReviewStats,
  type CompanionType,
  type CountItem,
  type FairReviewStats,
  type TagCountItem,
  type VisitPurpose,
} from "../../api/fairReviewStats";
import { DonutChart } from "./DonutChart";
import { TagRankingBoard } from "./TagRankingBoard";
import { TopTagBars } from "./TopTagBars";
...
/**
 * 태그 기반 리뷰 통계 위젯 묶음. FairStatsPage(/fair-admin/statistics)와
 * VisitStatisticsPage(/admin/dashboard/fairs/:fairId, /fair-admin/statistics의 대시보드 경로)가
 * 이 컴포넌트를 공유한다 - VisitStatsSection과 같은 이유로 위젯을 한곳에 뒀다.
 */
export function ReviewStatsSection({ fairId }: ReviewStatsSectionProps) {
