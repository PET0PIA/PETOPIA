...
const toneClass: Record<BadgeTone, string> = { primary: "bg-primary-soft text-primary", sun: "bg-sun-soft text-ink", leaf: "bg-leaf-soft text-ink", neutral: "bg-page text-muted" };
