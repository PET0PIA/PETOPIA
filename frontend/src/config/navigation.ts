...
import { BarChart3, CalendarDays, ClipboardCheck, FileCheck2, LayoutDashboard, Map, QrCode, ReceiptText, ScrollText, Settings2, Store, Ticket, UsersRound } from "lucide-react";
