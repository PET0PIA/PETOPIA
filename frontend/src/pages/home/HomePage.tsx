 ...
 * 불러 아래 세 곳(숫자 띠·다가오는 행사·참가 부스)이 나눠 쓴다 - 같은 응답을 쓰는데
...
export function HomePage() {
   ...
   * 한 숫자로 묶는다(예약만 열린 미래 행사는 아직 열린 게 아니라서 뺀다).
   *
  ...
  /*
   * 참가 부스 섹션에 쓸 대표 행사 하나. 지금 열려 있는 행사가 있으면 그걸 먼저 고르고,
   * 없으면 가장 임박한 행사를 쓴다 - "이번 행사의 참가 부스"라는 제목에 맞는 순서다.
   */
