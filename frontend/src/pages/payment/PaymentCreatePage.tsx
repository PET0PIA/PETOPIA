      ...
      <Card className="p-6">
        <form onSubmit={handleSubmit} className="grid gap-3 sm:grid-cols-4 sm:items-end">
          <div>
            ...
            <Input id="vf-application-id" type="number" min={1} value={applicationId} onChange={(event) => setApplicationId(event.target.value)} placeholder="예: 1" />
          </div>
          <div>
            <label htmlFor="vf-fair-id" className="mb-1.5 block text-sm font-bold text-ink">행사 ID</label>
            <Input id="vf-fair-id" type="number" min={1} value={fairId} onChange={(event) => setFairId(event.target.value)} placeholder="예: 1" />
          </div>
          <div>
            <label htmlFor="vf-business-id" className="mb-1.5 block text-sm font-bold text-ink">업체 ID</label>
            <Input id="vf-business-id" type="number" min={1} value={businessId} onChange={(event) => setBusinessId(event.target.value)} placeholder="예: 1" />
          </div>
          <div>
      ...
      <Card className="p-6">
        <form onSubmit={handleSubmit} className="grid gap-3 sm:grid-cols-3 sm:items-end">
          <div>
            ...
            <Input id="cf-payment-id" type="number" min={1} value={paymentId} onChange={(event) => setPaymentId(event.target.value)} placeholder="예: 1" />
          </div>
      ...
      <Card className="p-6">
        <form onSubmit={handleSubmit} className="flex flex-col gap-3 sm:flex-row sm:items-end">
          <div className="flex-1">
            ...
            <Input id="rd-reservation-id" type="number" min={1} value={reservationId} onChange={(event) => setReservationId(event.target.value)} placeholder="예: 1" />
          </div>
          <Button type="submit" disabled={submitting}>
            <Banknote size={16} />
      ...
      <Card className="p-6">
        <form onSubmit={handleSubmit} className="grid gap-3 sm:grid-cols-3 sm:items-end">
          <div>
            ...
            <Input id="of-fair-id" type="number" min={1} value={fairId} onChange={(event) => setFairId(event.target.value)} placeholder="예: 1" />
          </div>
          <div>
