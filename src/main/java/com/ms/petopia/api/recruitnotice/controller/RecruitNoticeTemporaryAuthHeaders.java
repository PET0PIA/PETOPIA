 ...
 *
 * <p>다른 도메인에도 내용이 같은 {@code TemporaryAuthHeaders}가 있다. 도메인 간 결합을
 ...
 * (추후 인증 도메인 완성 시 제거될 임시 코드다).
 */
public final class RecruitNoticeTemporaryAuthHeaders {

    public static final String USER_ID = "X-User-Id";

    private RecruitNoticeTemporaryAuthHeaders() {
    }
}