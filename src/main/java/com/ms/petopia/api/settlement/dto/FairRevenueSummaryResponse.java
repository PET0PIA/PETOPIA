 ...
 *
 * <p>기존 {@link SettlementResponse}(정산 1건 = 행사·사업자 조합, 참가비만, PENDING/CONFIRMED
 * 워크플로우 있음)와는 완전히 별개다. 이건 행사 하나를 통째로 - 예약금 + 참가비를
 ...
 * @param businessAmount  grossAmount - platformAmount - 행사 관리자(EVENT_ADMIN) 몫
 */
