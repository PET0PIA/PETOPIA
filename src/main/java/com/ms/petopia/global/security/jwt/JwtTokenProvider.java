...
public class JwtTokenProvider {
    ...
    */
    ...
    // Refresh Token은 Access Token 재발급용이라 role 같은 부가 정보는 필요 없고
    // 사용자 + 언제까지 유효한지만 있으면 된다. 만료 기간 2주.
    ...
    // 토큰을 열어서 안에 적힌 userId를 꺼내온다.
    // 서명 검증에 실패하면(위조 or 만료) parseClaims에서 예외가 터진다.
    ...
    // 토큰을 검증하고 안의 내용(claims)을 꺼내는 공통 로직.
